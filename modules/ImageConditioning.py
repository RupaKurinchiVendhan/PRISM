...
@dataclass
class ImageConditioningOutput(BaseOutput):
    down_block_res_samples: Tuple[torch.Tensor]




class ImageConditioningNet(ModelMixin, ConfigMixin):
    ...
    def forward(
    ...
    ) -> Union[ImageConditioningOutput, Tuple]:
        ...
        return ImageConditioningOutput(
